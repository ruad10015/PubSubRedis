...
using PubSubRedis.Models;
using StackExchange.Redis;
using System.Diagnostics;
using System.Text.Json;

namespace PubSubRedis.Controllers;
public class HomeController : Controller
{
    private readonly ILogger<HomeController> _logger;
    private static ConnectionMultiplexer redis = ConnectionMultiplexer.Connect("redis-13057.c321.us-east-1-2.ec2.redns.redis-cloud.com\", 13057");
